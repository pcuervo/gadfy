...
abstract class Ikantam_Buyback_Block_Cart_Abstract extends Mage_Core_Block_Template
{
    protected $_customer = null;
    protected $_buyback = null;
    ...
    {
        parent::__construct();
        $this->addItemRender('default', 'buyback/cart_item_renderer', 'ikantam/buyback/cart/item/default.phtml');
    }
    ...
    {
        if (null === $this->_buyback) {
            $this->_buyback = Mage::getSingleton('buyback/session');
        }
    ...
    {
        if (null === $this->_quote) {
            $this->_quote = $this->getBuyback()->getQuote();
        }
        return $this->_quote;
    }
     ...
     * @return  string
     */
    public function getItemHtml(Ikantam_Buyback_Model_Quote_Item $item)
    {
