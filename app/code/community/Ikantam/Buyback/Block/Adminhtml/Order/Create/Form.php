...
class Ikantam_Buyback_Block_Adminhtml_Order_Create_Form extends Ikantam_Buyback_Block_Adminhtml_Order_Create_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('buyback_order_create_form');
    }
