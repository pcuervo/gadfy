 ...
 */
class Ikantam_Buyback_Block_Adminhtml_Order_Create_Comment extends Ikantam_Buyback_Block_Adminhtml_Order_Create_Abstract
{
    protected $_form;
    ...
    {
        return Mage::helper('sales')->__('Buyback Order Comment');
    }
