...
class Ikantam_Buyback_Block_Adminhtml_Order_Create_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return Mage::getSingleton('buyback/adminhtml_session_quote')->getStore();
    }
    ...
    {
        return Mage::getSingleton('buyback/adminhtml_session_quote')->getQuote();
    }
    ...
    protected function _prepareCollection()
    {
        ...
        $collection
            ...
            ->addStoreFilter()
            ->addAttributeToFilter('type_id','buyback')
