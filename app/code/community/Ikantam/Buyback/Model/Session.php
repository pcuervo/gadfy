...
class Ikantam_Buyback_Model_Session extends Mage_Core_Model_Session_Abstract
{
    ...
    /**
     * Class constructor. Initialize buyback session namespace
     */
    ...
    {
        Mage::dispatchEvent('custom_quote_process', array('buyback_session' => $this));

        if ($this->_quote === null) {
            /** @var $quote Mage_Sales_Model_Quote */
            $quote = Mage::getModel('buyback/quote')->setStoreId(Mage::app()->getStore()->getId());
            if ($this->getQuoteId()) {
            ...
            if (!$this->getQuoteId()) {
                if ($customerSession->isLoggedIn() || $this->_customer) {
                    ...
                    Mage::dispatchEvent('buyback_quote_init', array('quote'=>$quote));
                }
            }
    ...
    public function loadCustomerQuote()
    {
        ...
        Mage::dispatchEvent('load_customer_quote_before', array('buyback_session' => $this));

        $customerQuote = Mage::getModel('buyback/quote')
