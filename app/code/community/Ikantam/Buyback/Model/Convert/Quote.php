 ...
 */
class Ikantam_Buyback_Model_Convert_Quote extends Mage_Sales_Model_Convert_Quote
{
    ...
    public function toOrder(Mage_Sales_Model_Quote $quote, $order=null)
    {
        ...
        Mage::helper('core')->copyFieldset('buyback_convert_quote', 'to_order', $quote, $order);
//        Mage::dispatchEvent('sales_convert_quote_to_order', array('order'=>$order, 'quote'=>$quote));
    ...
    public function addressToOrder(Mage_Sales_Model_Quote_Address $address, $order=null)
    {
        ...
        Mage::dispatchEvent('buyback_convert_quote_address_to_order', array('address'=>$address, 'order'=>$order));
        return $order;
    }
    ...
    {
        $orderAddress = Mage::getModel('buyback/order_address')
        ...
        Mage::dispatchEvent('buyback_convert_quote_address_to_order_address',
    ...
    {
        $orderItem = Mage::getModel('buyback/order_item')
        ...
        Mage::dispatchEvent('buyback_convert_quote_item_to_order_item',
