 ...
 */
class Ikantam_Buyback_Model_Quote_Address_Total_Nominal extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    /**
    ...
    {
        $collector = Mage::getSingleton('buyback/quote_address_total_nominal_collector',
