 ...
 */
class Ikantam_Buyback_Model_Quote_Address_Total_Collector extends Mage_Sales_Model_Config_Ordered
{
    /**
     ...
     * @var string
     */
    protected $_totalsConfigNode = 'global/buyback/quote/totals';
