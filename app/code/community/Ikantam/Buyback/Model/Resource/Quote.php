...
class Ikantam_Buyback_Model_Resource_Quote extends Mage_Sales_Model_Resource_Quote
{
    /**
...
//    }
    ...
    public function isOrderIncrementIdUsed($orderIncrementId)
    {
        ...
        $select->from($this->getTable('buyback/order'), 'entity_id')
...
//    }
    ...
    public function substractProductFromQuotes($product)
    {
        ...
        $subSelect->from(false, array(
            ...
            ->join(
                array('qi' => $this->getTable('buyback/quote_item')),
                implode(' AND ', array(
        ...
        $updateQuery = $adapter->updateFromSelect($subSelect, array('q' => $this->getTable('buyback/quote')));
    ...
    {
        $tableQuote = $this->getTable('buyback/quote');
        $tableItem = $this->getTable('buyback/quote_item');
        $subSelect = $this->_getReadAdapter()
            ->select()
