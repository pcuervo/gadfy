 ...
 */
class Ikantam_Buyback_Model_Resource_Order_Status_History_Collection
    extends Mage_Sales_Model_Resource_Order_Status_History_Collection
{
    /**
     * Event prefix
     *
     * @var string
     */
    protected $_eventPrefix    = 'buyback_order_status_history_collection';
    ...
    {
        $this->_init('buyback/order_status_history');
    }
