 ...
 */
class Ikantam_Buyback_Model_Resource_Quote_Item_Option_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    public function addItemFilter($item)
    {
        ...
        } elseif ($item instanceof Ikantam_Buyback_Model_Quote_Item) {
    ...
    {
        if ($item instanceof Ikantam_Buyback_Model_Quote_Item) {
            $itemId = $item->getId();
        } else {
            $itemId = $item;
        }
