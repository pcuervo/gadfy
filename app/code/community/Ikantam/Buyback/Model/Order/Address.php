 ...
 */
class  Ikantam_Buyback_Model_Order_Address extends Mage_Sales_Model_Order_Address
{
    protected $_order;

    protected $_eventPrefix = 'buyback_order_address';
    ...
    {
        if (!$this->_order) {
            $this->_order = Mage::getModel('buyback/order')->load($this->getParentId());
        }
        return $this->_order;
    }
