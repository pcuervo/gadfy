    ...
    $.fn.youamaAjaxLogin = function(options) {
        ...
        function validateDatas(windowName) {
            ...
            if (windowName == 'register') {
                ...
                }else if (validateEmail(opts.email) != opts.emailsecond) {
                    opts.errors = opts.errors + 'notsameemail,'
                }
        ...
        function setDatas(windowName) {
            ...
            if (windowName == 'register') {
                ...
                opts.emailecond = $('.youama-' + windowName
                    + '-window #youama-emailsecond').val();
